...
import com.combat.domain.message.DomainEventDispatchHandler;
...
public class DisruptorFactory implements EventFactory {
    ...
    protected final Map<String/*topic*/, TreeSet<DomainEventHandler>> handlesMap;
    ...
    private Disruptor createDw(final String topic) {
        ...
        return new Disruptor(this, Executors.newCachedThreadPool(new ThreadFactory() {
            @Override
